...
function DevuelveReInscriptos (props) {
...
const diaDeHoy=()=>{
 ...
 return(
      ...
      <div className="grid-container">
        ...
        <h4><strong>Menu de Re Apertura de Inscripcion de Postulantes</strong></h4>
        <h4>Total de Postulantes inscriptos al {diaDeHoy().toLocaleDateString()+" : "}<strong>{postulantes.data.length}
          </strong></h4>
...
<div className="footer">
    ...
    )}export default DevuelveReInscriptos