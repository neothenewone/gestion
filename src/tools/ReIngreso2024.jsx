...
import DevuelveReInscriptos from './devuelveReInscriptos';




function ReIngreso2024 () {
...
const [usuarioSeleccionado,setUsuario]=useState({})
 ...
 const URI='https://apps.isepsantafe.edu.ar/inscriptos/RE/devuelve'
...
const usuarioLoguead=ObtieneDatosCookies()
  ...
  return (
    ...
    <div style={{textAlign:'center'}}>{cargando && (<h2>Cargando Postulantes Reapertura...</h2>)}
    {cargando && (<Spinner color='priority'/>)}
    </div>  
     {usuariosVarios?"":""}
     <div style={{textAlign:'center'}}>{usuariosVarios?<section  className="datos-personales">
        
        {usuariosVarios?<DevuelveReInscriptos datos={usuariosVarios}/>:""}
