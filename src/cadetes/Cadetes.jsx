...
const cursos=[
    {"id":1,"curso":"Curso 2023-2024","escuela":"Escuela de Policia","api":"https://wwwa.isepsantafe.edu.ar/expedientes/curso2023-2024/","estado":"Activo"},
...
const muestraCadetes=async(datillo,condicion)=>{
  const client = axios.create({
      ...
      try {
        await client.post('/consulta/'+condicion).then(f=>setCadetes(f.data)).then(setMuestroCadetes(true))
...
<div style={{textAlign:"center", backgroundColor:"orange", margin:"5px"}}>
           <h1 >Menu de Gestion de Cadetes</h1> 
